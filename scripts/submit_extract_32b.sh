#!/bin/bash
#SBATCH --job-name=harvest-32b-l32
...
#SBATCH --output=/home/rkathuria/activation-harvester/logs/extract-32b-%j.out
#SBATCH --error=/home/rkathuria/activation-harvester/logs/extract-32b-%j.err

set -euo pipefail

REPO=/home/rkathuria/activation-harvester
OUT=/data/artifacts/rohan/activation-harvester/olmo32b_l32
