#!/bin/bash
#SBATCH --job-name=harvest-32b-dp2tp4-fp8
...
#SBATCH --output=/home/rkathuria/activation-harvester/logs/sglang-32b-dp2tp4-fp8-%j.out
#SBATCH --error=/home/rkathuria/activation-harvester/logs/sglang-32b-dp2tp4-fp8-%j.err

set -euo pipefail

REPO=/home/rkathuria/activation-harvester
OUT=/data/artifacts/rohan/activation-harvester/sglang-32b-l32-dp2tp4-fp8
